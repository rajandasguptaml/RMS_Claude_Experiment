...
// Raw shape pieces used both by per-section schemas and the composed schema.
const basicShape = {
...
export const guestBasicSchema = z.object(basicShape)
export const guestContactSchema = z.object(contactShape)

export const guestVisaSchema = z.object(visaShape).superRefine((val, ctx) => {
...
export const guestPassportSchema = z.object(passportShape).superRefine((val, ctx) => {
...
export const guestAdditionalSchema = z.object(additionalShape)
